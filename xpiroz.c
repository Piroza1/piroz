...

{
      	...
      	int ch,days,H,M,num,passin;      	char user[999];
   ...
   printf("\033[1;34m\nMinutes: \033[0m");
    ...
    case 10:
      ...
      fflush(stdin);
		  ...
		  printf("\033[1;31m\nAre you sure you want to remove this script [y/n]: \033[0m");
